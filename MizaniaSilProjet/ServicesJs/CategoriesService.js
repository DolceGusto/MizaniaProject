(function () {
    var categoriesService = function ($http, $q, $log) {
        ...
        var InsertCategorie = function (categorie) {
            return $http.post("http://localhost:1949/api/Categorie/addCategorie", categorie)
            .then(function () {
        ...
        var deleteCategorie = function (categorie) {
            return $http.delete("http://localhost:1949/api/Categorie/deleteCategorie/" + categorie.id)
            .then(function (result) {
